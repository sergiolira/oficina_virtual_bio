...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Licencia</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_lic_modal" data-id="0">Nueva Licencia</button>
                  <button type="button" class="btn btn-success exportar-excel-lic" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                <?php } ?>
               </div>
               
              <!-- /.card-header -->
              <div class="card-body  table_lic">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-lic">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_lic">Licencia</h4>
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_glic">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-lic">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles Licencia</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_lic">
...
<!-- js herramienta -->
<script src="js/js_licencia.js"> </script>
<script> 
     list_licencia();
</script>
