...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Modulos</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-modulo" data-id="0">Nuevo modulo</button>
                    <button type="button" class="btn btn-success exportar-excel-modulos" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                </div>
              <?php }?>
                <div class="card-body table-tipo-modulo">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <div class="modal fade" id="modal-form-modulo">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form_modulo" id="form_modulo">
        ...
        <!-- FIN MODAL TIPO modulo -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-modulo">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form class="form_show_modulo" id="form_show_modulo">
...
<!-- js_Modulos -->
<script src="js/js_modulo.js"></script>
<!-- page script -->
<script>
  list_modulos();
