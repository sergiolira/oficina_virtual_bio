          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_w_h_modal" data-id="0">Nuevo Web header</button>
                  <button type="button" class="btn btn-success exportar-excel-web-header" title="Exportar Excel" id="exportable">
