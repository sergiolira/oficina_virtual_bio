  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Web Quienes Somos</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Web Quienes Somos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Web Quienes Somos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="modal fade" id="modal_form-web_quienes_somos">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Web Quienes Somos</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form_web_quienes_somos" id="form_web_quienes_somos" role="form" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-form-show-web_quienes_somos">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!-- INICIA MODAL imagen portada-->
        <div class="modal fade" id="modal_imagen_portada">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!-- FIN MODAL imagen portada-->

        <!-- INICIA MODAL Cargar imagen-->
        <div class="modal fade" id="modal_form-cargar_portada">
            <div class="modal-dialog modal-gl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Cargar portada</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form_cargar_portada" id="form_cargar_portada" role="form" enctype="multipart/form-data">
...
<script src="js/js_web_quienes_somos.js"></script> 
<script>
