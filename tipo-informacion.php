...
<head>
  ...
  <title>Tipo de informacion</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Tipo de informacion</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tipo de Informacíon</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tipo Informacion</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-infor" data-id="0">Nueva Informacíon</button>
                </div>
                <?php }?>
                <div class="card-body table-tipo-infor">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO INFORMACION -->
        <div class="modal fade" id="modal-form-informacion">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Tipo de informacion</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_informacion" id="form_informacion">
        ...
        <!-- FIN MODAL TIPO INFORMACION -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-informacion">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalles tipo de informacion</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form id="form_show_informacion">
...
<!-- js_tipo_informacion -->
<script src="js/tipo_informacion.js"></script>
<!-- page script -->
<script>
  list_tipoinfo();
