...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-paquete_detalle_producto" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo detalle paquete</button>
                </div>
              <?php }?>
                <div class="card-body table-paquete_detalle_producto">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO paquete_detalle_producto -->
        <div class="modal fade" id="modal-form-paquete_detalle_producto">
        ...
        <!-- FIN MODAL TIPO paquete_detalle_producto -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-paquete_detalle_producto">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <form class="form_show_paquete_detalle_producto" id="form_show_paquete_detalle_producto">
