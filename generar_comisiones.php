  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Trama de ventas</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Generar comisiones</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Generar comisiones</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
             <div class="card">
                ...
                <div class="card-header"  align="center">
                    <button class="btn btn-info btn-sm generar-comisiones-oncosalud" data-id="0">Generar Comisisiones</button>
             ...
             <!-- /.card-header -->
             <div class="card-body tbody_list"></div>
          </div>
        </div>
      <!-- /.modal -->
...
<!-- js herramienta -->
<script src="js/js_generar_comisiones.js"> </script>

<script>
    moment.locale('es');
    combo_anio_no_generados();
    $('#slt_anio_c').select2({
      theme: 'bootstrap4'
    });    
</script>
