  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Herramientas tecnologicas</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Herramientas tecnologicas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Herramienta tecnologica</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_h_tec_modal" data-id="0">Nueva Herramienta tecnologica</button>
                  <button type="button" class="btn btn-success exportar-excel-h-tec" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                <?php } ?>
               </div>
               
              <!-- /.card-header -->
              <div class="card-body  table_h_tec">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-h_tec">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_h_tec">Herramienta tecnologica</h4>
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gh_tec">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-h_tec">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles de herramienta tecnologica</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_h_tec">
...
<!-- js herramienta -->
<script src="js/js_herramienta_tecnologica.js"> </script>
<script> 
