          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_wffbr_modal" data-id="0">Nuevo Web footer four bottom right</button>
                  <button type="button" class="btn btn-success exportar-excel-web-footer-four" title="Exportar Excel" id="exportable">
