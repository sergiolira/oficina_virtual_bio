...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Roles</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                  <?php if
                  ($_SESSION['crear']==1 || $_SESSION['idUser']==1) {
                   ?>
                    <button class="btn btn-info new-modal-rol" data-id="0">Nuevo rol</button>
                    <button type="button" class="btn btn-success exportar-excel-rol" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                    <?php }?>
                </div>
                <div class="card-body table-roles">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <div class="modal fade" id="modal-form-rol">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form_rol" id="form_rol">
        ...
        <!-- FIN MODAL rol -->
                <!-- INICIA MODAL  permiso -->
        <div class="modal fade" id="modal-form-permiso">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">permiso de roles</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form class="form_permiso" id="form_permiso">
        ...
        <div class="modal fade" id="modal-form-show-rol">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form class="form_show_rol" id="form_show_rol">
...
<!-- js_archivo -->
<script src="js/js_rol.js"></script>
<script src="js/js_permiso.js"></script>
<!-- page script -->
<script>
  list_roles();  
</script>
