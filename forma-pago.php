  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Forma de pago</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">forma pago</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-info new-modal-forma-pago" data-id="0">Nueva forma pago</button>
                </div>
                <div class="card-body table-forma-pago">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL FORMA DE PAGO -->
        <div class="modal fade" id="modal-form-forma-pago">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Estilo de ancho</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_forma_pago" id="form_forma_pago">
        ...
        <div class="modal fade" id="modal-form-show-forma-pago">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle forma de pago</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form id="form_show_forma_pago">
...
<!-- js_forama de pago-->
<script src="js/forma_pago.js"></script>
<!-- page script -->
<script>
  list_forma_pago();
