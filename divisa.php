  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">divisa</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Divisa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-divisa" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nueva divisa</button>
                </div>
              <?php }?>
                <div class="card-body table-divisa">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO divisa -->
        <div class="modal fade" id="modal-form-divisa">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Tipo de divisa</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_divisa" id="form_divisa">
        ...
        <!-- FIN MODAL TIPO divisa -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-divisa">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle de divisa</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_divisa" id="form_show_divisa">
...
<!-- js_divisa -->
<script src="js/js_divisa.js"></script>
<!-- page script -->
<script>
  list_divisa();
