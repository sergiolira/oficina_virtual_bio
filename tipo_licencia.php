  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Tipo de licencia</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tipo de licencia</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tipo de licencia</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
          <div class="col-12">
             ...
             <?php if ($_SESSION['crear']==1) { ?>
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_tipo_lic_modal" data-id="0">Nuevo tipo de licencia</button>
                  <button type="button" class="btn btn-success exportar-excel-tip-lic" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                <?php } ?>
               </div>
               <?php }?>
              <!-- /.card-header -->
              <div class="card-body  table_tipo_lic">
              
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-tipo_lic">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_tipo_lic">Tipo de licencia</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
              <div class="modal-body">
                <form id="form_tipo_lic">
               
                </form>
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gtipo_lic">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-tipo_lic">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles tipo de licencia</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_tipo_lic">
...
<!-- js herramienta -->
<script src="js/js_tipo_licencia.js"> </script>
<script> 
     list_tipo_licencia();
</script>
