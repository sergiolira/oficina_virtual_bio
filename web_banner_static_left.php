  ...
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="modal-form-web-testimonio">
      ...
      <div class="modal fade" id="modal-show-web-testimonio">
        ...
        <!-- modal pdf pre-view--> 
        <div class="modal fade" id="modal-show-pdf">
                <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title ">Vista Previa Pdf</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                        <iframe  id="preview_pdf" src="" type="application/pdf" style="width:100%; height:700px;" frameborder="0" ></iframe>
                    <div class="modal-footer" style="justify-content: center;">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    </div>
                    </div>
...
<!-- js herramienta -->
<script src="js/js_web_banner_static_left.js"> </script>
<script> 
