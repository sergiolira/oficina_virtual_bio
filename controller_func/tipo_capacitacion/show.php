...
?>
  ...
  <div class="row"> 
                   ...
                   <div class="col-4">
                            <label for="txt_t_c">Tipo de capacitacion<i class="text-danger" title="Ingrese tipo capacitacion"></i>
                            <label class="txt-danger msj-txt_nombre"></label></label>
                          <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                 <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                              </div>
                              <input type="text" class="form-control"  id="txt_t_c" name="txt_t_c" 
                              value="<?php echo $obj_t_c->tipo_capacitacion; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              value="<?php echo $obj_t_c->fechaactualiza; ?>"/>
                          </div>
                   </div>
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_t_c->fecharegistro; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_t_c->id_usuarioactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_t_c->id_usuarioregistro; ?>"/>
                          </div>
                   </div>
