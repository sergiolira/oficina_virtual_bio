...
$objPHPExcel->getProperties()->setCreator("Freky")
							 ...
							 ->setTitle("Documento tipo de capacitacion Office 2007 XLSX")
							 ->setSubject("Documento tipo de capacitacion Office 2007 XLSX")
							 ->setDescription("Documento tipo de capacitacion para Office 2007 XLSX, generado usando clases PHP.")
							 ->setKeywords("Office 2007 openxml php")
							 ->setCategory("Documento tipo de capacitacion");

// Agrega algunos datos (Titulos)
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Nº')
            ->setCellValue('B1', 'ID')
            ->setCellValue('C1', 'Tipo de capacitacion')
...
while($fila=mysqli_fetch_assoc($rs)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
	            ->setCellValue("A$i", $c)
	            ->setCellValue("B$i", $fila["id_tipo_capacitacion"])
	            ->setCellValue("C$i", $fila["tipo_capacitacion"])
...
$response =  array(
        ...
        'namearchivo'=>'Tipo_capacitacion_'.date('dmy')."_".date('Hs')."_".rand(10, 99)
    );
