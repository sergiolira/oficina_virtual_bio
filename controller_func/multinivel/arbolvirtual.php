...
if($fila_n_uno=mysqli_fetch_assoc($rs_n_uno)){
  ...
  $ruc1=$fila_n_uno["ruc"];
  $ruc_representante_back=$fila_n_uno["patrocinador"];
  $texto_link="consultar-arbol";
  $disabled_button_back="";
  if($ruc_representante_back=="Lider de Red" || $ruc_representante_back=="0"){
    $ruc_representante_back="0";
    $texto_link="";
    $disabled_button_back="disabled";
  }
...
<!--Arbol Inicio-->
<style type="text/css">
.cursor-pointer {cursor: pointer;color:black}

</style>
<table id="Tabla_01" width="100%">
  <tr><!--Espacio-->
  </tr>
  <tr>
    ...
    <td colspan="10" >
      <!--Usuario Nivel 1-->
      <label align="center" style="font-size: 14px"style="font-size: 14px"><?php echo $nombre1;?></label>
    </td>
    <td colspan="54" rowspan="4">
      <img src="images/arbolgenealogico_04.gif" width="465" height="97" alt=""><button class="btn btn-outline-success btn-lg <?php echo $texto_link;?>" <?php echo $disabled_button_back;?> data-id="<?php echo $ruc_representante_back?>">Back <i class="fas fa-chevron-circle-left"></i></button></td>
    <td>
      <img src="images/espacio.gif" width="1" height="23" alt="">
      </td>
  </tr>
  <tr>
   <!--Espacio-->
  ...
  <tr>
    ...
    <td colspan="8">
      <!--Usuario Nivel 2.1-->
      <?php if($ruc2_izq!=""){?>
         <label align="center"  style="font-size: 14px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc2_izq?>" ><?php echo /*$ruc2_izq." ".*/$nombre2_izq;?></a></label>
      <?php }else{?>
    ...
    <td colspan="9">
      <!--Usuario Nivel 2.2-->
      <?php if($ruc3_der!=""){?>
        <label align="center" style="font-size: 14px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc3_der?>" ><?php echo /*$ruc3_der." ".*/$nombre3_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
  ...
  <tr>
    ...
    <td colspan="5">
      <!--Usuario Nivel 2.1-->
      <?php if($ruc2_izq!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc2_izq?>" >
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="5">
      <!--Usuario Nivel 2.2-->
      <?php if($ruc3_der!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc3_der?>" >
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
  ...
  <tr>
    ...
    <td colspan="10" rowspan="2">
      <!--Usuario Nivel 3.1-->
      <?php if($ruc4_izq!=""){?>
        <label align="center" style="font-size: 14px" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc4_izq?>" ><?php echo /*$ruc4_izq." ".*/$nombre4_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="10" rowspan="2">
      <!--Usuario Nivel 3.2-->
      <?php if($ruc5_der!=""){?>
        <label align="center" style="font-size: 14px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc5_der?>" ><?php echo /*$ruc5_der." ".*/$nombre5_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="8" rowspan="2">
      <!--Usuario Nivel 3.3-->
      <?php if($ruc6_izq!=""){?>
        <label align="center" style="font-size: 14px" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc6_izq?>" ><?php echo /*$ruc6_izq." ".*/$nombre6_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="11">
      <!--Usuario Nivel 3.4-->
      <?php if($ruc7_der!=""){?>
        <label align="center" style="font-size: 14px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc7_der?>" ><?php echo /*$ruc7_der." ".*/$nombre7_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
  ...
  <tr>
    ...
    <td colspan="5">
      <!--Usuario Nivel 3.1-->
      <?php if($ruc4_izq!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc4_izq?>" >
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="5">
      <!--Usuario Nivel 3.2-->
      <?php if($ruc5_der!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc5_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="5">
      <!--Usuario Nivel 3.3-->
      <?php if($ruc6_izq!=""){?>
        <div class="widget-user-image" align="center"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc6_izq?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="5">
      <!--Usuario Nivel 3.4-->
      <?php if($ruc7_der!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc7_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
  ...
  <tr>
    ...
    <td colspan="8" rowspan="2">
      <!--Usuario Nivel 4.1-->
      <?php if($ruc8_izq!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc8_izq?>"><?php echo /*$ruc8_izq." ".*/$nombre8_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="8">
      <!--Usuario Nivel 4.2-->
      <?php if($ruc9_der!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc9_der?>"><?php echo /*$ruc9_der." ".*/$nombre9_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="9" rowspan="2">
      <!--Usuario Nivel 4.3-->
      <?php if($ruc10_izq!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc10_izq?>"><?php echo /*$ruc10_izq." ".*/$nombre10_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="9" rowspan="2">
      <!--Usuario Nivel 4.4-->
      <?php if($ruc11_der!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc11_der?>"><?php echo /*$ruc11_der." ".*/$nombre11_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="8" rowspan="2">
      <!--Usuario Nivel 4.5-->
      <?php if($ruc12_izq!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc12_izq?>"><?php echo /*$ruc12_izq." ".*/$nombre12_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    <td colspan="8" rowspan="2">
      <!--Usuario Nivel 4.6-->
      <?php if($ruc13_der!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc13_der?>"><?php echo /*$ruc13_der." ".*/$nombre13_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="9" rowspan="2">
      <!--Usuario Nivel 4.7-->
      <?php if($ruc14_izq!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc14_izq?>"><?php echo /*$ruc14_izq." ".*/$nombre14_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="8" rowspan="2">
      <!--Usuario Nivel 4.8-->
      <?php if($ruc15_der!=""){?>
        <label align="center" style="font-size: 13px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc15_der?>"><?php echo /*$ruc15_der." ".*/$nombre15_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
  ...
  <tr>
    ...
    <td colspan="6">
      <!--Usuario Nivel 4.1-->
      <?php if($ruc8_izq!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc8_izq?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="6">
      <!--Usuario Nivel 4.2-->
      <?php if($ruc9_der!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc9_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="7">
      <!--Usuario Nivel 4.3-->
      <?php if($ruc10_izq!=""){?>
        <div class="widget-user-image" align="center" ><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc10_izq?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="7">
      ...
      <?php if($ruc11_der!=""){?>
        <div class="widget-user-image" align="center" >
          <a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc11_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="6">
      ...
      <?php if($ruc12_izq!=""){?>
        <div class="widget-user-image" align="center" >
          <a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc12_izq?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="6">
      ...
      <?php if($ruc13_der!=""){?>
        <div class="widget-user-image" align="center" >
          <a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc13_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="7">
      ...
      <?php if($ruc14_izq!=""){?>
        <div class="widget-user-image" align="center" >
          <a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc14_izq?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
    ...
    <td colspan="6">
      ...
      <?php if($ruc15_der!=""){?>
        <div class="widget-user-image" align="center" >
          <a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc15_der?>">
          <img class="img-circle elevation-2" src="imas/logo/usulider.png" alt="User Avatar"></a>
        </div>
      <?php }else{?>
        <div class="widget-user-image" align="center" >
  ...
  <tr>
    ...
    <td colspan="5">
      <!--Usuario Nivel 5.1-->
      <?php if($ruc16_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc16_izq?>"><?php echo /*$ruc16_izq." ".*/$nombre16_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.2-->
      <?php if($ruc17_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc17_der?>"><?php echo /*$ruc17_der." ".*/$nombre17_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.3-->
      <?php if($ruc18_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc18_izq?>"><?php echo /*$ruc18_izq." ".*/$nombre18_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.4-->
      <?php if($ruc19_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc19_der?>"><?php echo /*$ruc19_der." ".*/$nombre19_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.5-->
      <?php if($ruc20_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc20_izq?>"><?php echo /*$ruc20_izq." ".*/$nombre20_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.6-->
      <?php if($ruc21_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc21_der?>"><?php echo /*$ruc21_der." ".*/$nombre21_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.7-->
      <?php if($ruc22_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc22_izq?>"><?php echo /*$ruc22_izq." ".*/$nombre22_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.8-->
      <?php if($ruc23_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc23_der?>"><?php echo /*$ruc23_der." ".*/$nombre23_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.9-->
      <?php if($ruc24_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc24_izq?>"><?php echo /*$ruc24_izq." ".*/$nombre24_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.10-->
      <?php if($ruc25_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc25_der?>"><?php echo /*$ruc25_der." ".*/$nombre25_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.11-->
      <?php if($ruc26_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc26_izq?>"><?php echo /*$ruc26_izq." ".*/$nombre26_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="6">
      <!--Usuario Nivel 5.12-->
      <?php if($ruc27_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc27_der?>"><?php echo /*$ruc27_der." ".*/$nombre27_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.13-->
      <?php if($ruc28_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc28_izq?>"><?php echo /*$ruc28_izq." ".*/$nombre28_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.14-->
      <?php if($ruc29_der!=""){?>
        <label align="center" style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc29_der?>"><?php echo /*$ruc29_der." ".*/$nombre29_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
    ...
    <td colspan="7">
      <!--Usuario Nivel 5.15-->
      <?php if($ruc30_izq!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc30_izq?>"><?php echo /*$ruc30_izq." ".*/$nombre30_izq;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    <td rowspan="5">
    ...
    <td colspan="5">
      <!--Usuario Nivel 5.16-->
      <?php if($ruc31_der!=""){?>
        <label align="center"  style="font-size: 11px"><a href="javascript:void(0)"  rel="nofollow"  class="cursor-pointer consultar-arbol" data-id="<?php echo $ruc31_der?>"><?php echo /*$ruc31_der." ".*/$nombre31_der;?></a></label>
      <?php }else{?>
        <label align="center" style="font-size: 14px"></label>
      <?php }?>
    </td>
