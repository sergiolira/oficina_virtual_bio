...
$obj->consultar_representante();
 $estado_d="";
 if($obj->nro_documento!=""){ $estado_d="disabled"; }
...
<div class="row">
            ...
            <div class="col-4 div_nombre">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="hidden" name="txtsponsor" id="txtsponsor" value="Cabeza de Red">
            ...
            <div class="col-4">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Enter RUC" id="txtdireccion" name="txtdireccion" value="<?php echo $obj->direccion?>">
              </div>
            </div>           
            ...
            <div class="col-4">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Telefono" id="txttelefono" name="txttelefono" maxlength="9"  
                  ...
                  <select class="form-control" id="slttipdoc" name="slttipdoc" style="width: 70%;">
                    <option  value="0" >.::Elige::.</option>
                        <?php
                          ...
                          ?>
                          <option  value="<?php echo $fila_td["id_tipo_documento"]?>" 
                          <?php if($obj->id_tipo_documento==$fila_td["id_tipo_documento"]){echo "selected";}?>>
            ...
            <?php if($obj->tipo_persona=="PN" || $_GET["id"]==0){?>
             <div class="col-4">
              <label for="txtruc" class="lbl_nro_doc">N° de documento</label>
              <i class="text-danger" title="Complete este campo">*</i><label class="text-danger msj_ruc"></label>
              <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="far fa-user"></i></span>
                  </div>
            ...
            <?php }else{?>
            <div class="col-4">
              <label for="txtruc" class="lbl_nro_doc">RUC / Codigo fiscal</label>
              <i class="text-danger" title="Complete este campo">*</i><label class="text-danger msj_ruc"></label>
              <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="far fa-user"></i></span>
