...
<div class="row">
    ...
    <div class="col-4">
        <label for="txt_cat">Categoria </label>
    ...
    <div class="col-4">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $obj_cp->fechaactualiza; ?>"/>
        </div>
    </div>   
    <div class="col-4">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $obj_cp->fecharegistro; ?>"/>
        </div>
    </div>   
    <div class="col-4">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $obj_cp->id_usuarioregistro; ?>"/>
        </div>
    </div>   
    <div class="col-4">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $obj_cp->id_usuarioactualiza; ?>"/>
        </div>
    </div>    
