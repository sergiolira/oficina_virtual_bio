                ...
                <div class="col-4">
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              value="<?php echo $obj_costo_envio->fechaactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_costo_envio->fecharegistro; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_costo_envio->id_usuarioactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_costo_envio->id_usuarioregistro; ?>"/>
                          </div>
                   </div>  
</div>