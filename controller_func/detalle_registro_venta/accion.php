...
$obj_detalle_registro_venta= new detalle_registro_venta();
    ...
    if($_REQUEST["id"]>0){
        ...
        $obj_detalle_registro_venta->id_detalle_registro_venta=intval($_REQUEST["id"]);
        ...
        $obj_detalle_registro_venta->sub_total= strClean($_REQUEST["txt_sub_total"]);
        ...
        $obj_detalle_registro_venta->id_descuento_producto= strClean($_REQUEST["slt_descuento"]);
        $obj_detalle_registro_venta->observacion=strClean($_REQUEST["txt_observacion"]);
        if ($obj_detalle_registro_venta->id_detalle_registro_venta==0) {
         echo "error_datos";
         return false;
        }else{
        ...
        $obj_detalle_registro_venta->nro_solicitud=date('dmy')."_".date('Hs')."_".rand(10,99);
        $obj_detalle_registro_venta->id_tipo_venta= strClean($_REQUEST["slt_tipo_venta"]);
        $obj_detalle_registro_venta->cantidad= strClean($_REQUEST["txt_cantidad"]);
        $obj_detalle_registro_venta->precio_unitario= strClean($_REQUEST["txt_precio_unitario"]);
        $obj_detalle_registro_venta->sub_total= strClean($_REQUEST["txt_sub_total"]);
        ...
        $obj_detalle_registro_venta->id_descuento_producto= strClean($_REQUEST["slt_descuento"]);
        $obj_detalle_registro_venta->observacion=strClean($_REQUEST["txt_observacion"]);
        if ($obj_detalle_registro_venta->id_tipo_venta ==0) {
                 echo "error_datos";
                 return false;
        } else {
