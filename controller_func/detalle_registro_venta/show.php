...
$obj_detalle_registro_venta->id_detalle_registro_venta=$_REQUEST["id"];
$obj_detalle_registro_venta->consult();

if($obj_detalle_registro_venta->estado == 1){
  $estado="Activo";
...
?>
<div class="row"> 
                <input type="hidden" name="id" value="<?php echo $obj_detalle_registro_venta->id_estado_registro_venta; ?>">
                    <div class="col-4">
                        ...
                        <select class="form-control" name="slt_tipo_venta" id="slt_tipo_venta">
                            ...
                            ?>
                        <option <?php if($obj_detalle_registro_venta->id_tipo_venta==$fila_p["id_tipo_venta"]){ echo "selected";}?> value="<?php echo $fila_p["id_tipo_venta"]?>"><?php echo $fila_p["tipo_venta"]?></option>
                            <?php }?>
                        </select>
                        </div>
                    </div>
            ...
            <div class="col-4">
                ...
                <select class="form-control" name="slt_paquete" id="slt_paquete">
                    ...
                    ?>
                    <option <?php if($obj_detalle_registro_venta->id_paquete==$fila_p["id_paquete_producto_cabecera"]){ echo "selected";}?> value="<?php echo $fila_p["id_paquete_producto_cabecera"]?>"><?php echo $fila_p["nombre_paquete"]?></option>
                        <?php }?>
                </select>
                </div>
            </div>
                    <div class="col-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" class="form-control valid validNumber"  id="txt_cantidad" name="txt_cantidad" value="<?php echo $obj_detalle_registro_venta->cantidad; ?>"/>
                        </div>
                    </div>
                    <div class="col-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" class="form-control valid validNumber"  id="txt_precio_unitario" name="txt_precio_unitario" value="<?php echo $obj_detalle_registro_venta->precio_unitario; ?>"/>
                        </div>
                    </div>   
                    <div class="col-4">
                        ...
                        <select class="form-control" name="slt_descuento" id="slt_descuento">
                            ...
                            ?>
                            <option <?php if($obj_detalle_registro_venta->id_descuento_producto==$fila_p["id_descuento_producto"]){ echo "selected";}?> value="<?php echo $fila_p["id_descuento_producto"]?>"><?php echo $fila_p["monto"]?></option>
                                <?php }?>
                        </select>
                        </div>
                    </div>   
                    <div class="col-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" class="form-control valid validNumber"  id="txt_sub_total" name="txt_sub_total" value="<?php echo $obj_detalle_registro_venta->sub_total; ?>"/>
                        </div>
                    </div>  
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  id="txt_observacion" name="txt_observacion" value="<?php echo $obj_detalle_registro_venta->observacion; ?>"/>
                          </div>
                   </div>   
                   <div class="col-4">
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              value="<?php echo $obj_detalle_registro_venta->fechaactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_detalle_registro_venta->fecharegistro; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_detalle_registro_venta->id_usuarioactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_detalle_registro_venta->id_usuarioregistro; ?>"/>
                          </div>
                   </div>  
</div>