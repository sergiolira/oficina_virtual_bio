...
while($fila=mysqli_fetch_assoc($rs)){
  ...
  <td class="itemrow_d'.$fila["nro_solicitud"].'">
    <form action="show-solicitud-arbol-virtual-admin.php" method="POST" id="frmshowsoliarbolvirtual'.$fila["nro_solicitud"].'">
    ...
    <button class="btn btn-warning btn-xs show-solicitud-arbol-virtual-admin"  '.$estado_boton.' data-id="'.$fila["nro_solicitud"].'"> Ver Solicitud <i class="far fa-eye"></i></button>
    </center>
  </td>
  </tr>';
}
