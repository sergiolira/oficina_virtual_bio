...
$objPHPExcel->getProperties()->setCreator("Freky")
							 ...
							 ->setTitle("Documento estado candidato Office 2007 XLSX")
							 ->setSubject("Documento estado candidato Office 2007 XLSX")
							 ->setDescription("Documento estado candidato para Office 2007 XLSX, generado usando clases PHP.")
							 ->setKeywords("Office 2007 openxml php")
							 ->setCategory("Documento estado candidato");
...
while($fila=mysqli_fetch_assoc($rs)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
	            ->setCellValue("A$i", $c)
	            ->setCellValue("B$i", $fila["id_estado_candidato"])
	            ->setCellValue("C$i", $fila["estado_candidato"])
...
$response =  array(
        ...
        'namearchivo'=>'Estado_Candidato_'.date('dmy')."_".date('Hs')."_".rand(10, 99)
    );
