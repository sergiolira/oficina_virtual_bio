...
$objPHPExcel->getProperties()->setCreator("Freky")
							 ...
							 ->setTitle("Documento rol Office 2007 XLSX")
							 ->setSubject("Documento rol Office 2007 XLSX")
							 ->setDescription("Documento rol para Office 2007 XLSX, generado usando clases PHP.")
							 ->setKeywords("Office 2007 openxml php")
							 ->setCategory("Documento rol");
...
while($fila=mysqli_fetch_assoc($rs)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
	            ->setCellValue("A$i", $c)
	            ->setCellValue("B$i", $fila["id_rol"])
	            ->setCellValue("C$i", $fila["rol"])
...
$response =  array(
        ...
        'namearchivo'=>'rol_'.date('dmy')."_".date('Hs')."_".rand(10, 99)
    );
