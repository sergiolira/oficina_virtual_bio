...
?>
  ...
  <div class="row"> 
                   ...
                   <div class="col-4">
                            <label for="txt_tipo_e">Tipo de equipo<i class="text-danger" title="Ingrese tipo de equipo"></i>
                            <label class="txt-danger msj-txt_nombre"></label></label>
                          <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                 <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                              </div>
                              <input type="text" class="form-control"  id="txt_tipo_e" name="txt_tipo_e" 
                              value="<?php echo $obj_tipo_e->tipo_equipo; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              value="<?php echo $obj_tipo_e->fechaactualiza; ?>"/>
                          </div>
                   </div>
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_tipo_e->fecharegistro; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_tipo_e->id_usuarioactualiza; ?>"/>
                          </div>
                   </div>
                   ...
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  
                              value="<?php echo $obj_tipo_e->id_usuarioregistro; ?>"/>
                          </div>
                   </div>
