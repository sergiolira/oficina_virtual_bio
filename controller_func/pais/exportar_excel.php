...
$objPHPExcel->getProperties()->setCreator("Freky")
							 ...
							 ->setTitle("Documento país Office 2007 XLSX")
							 ->setSubject("Documento país Office 2007 XLSX")
							 ->setDescription("Documento país para Office 2007 XLSX, generado usando clases PHP.")
							 ->setKeywords("Office 2007 openxml php")
							 ->setCategory("Documento país");
...
$response =  array(
        ...
        'namearchivo'=>'Pais'.date('dmy')."_".date('Hs')."_".rand(10, 99)
    );
