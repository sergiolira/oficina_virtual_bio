...
$obj_a_herr= new asignacion_herramienta();
...
$objPHPExcel->getProperties()->setCreator("Freky")
							 ...
							 ->setTitle("Documento asignación de herramienta Office 2007 XLSX")
							 ->setSubject("Documento asignación de herramienta Office 2007 XLSX")
							 ->setDescription("Documento asignación de herramienta para Office 2007 XLSX, generado usando clases PHP.")
							 ->setKeywords("Office 2007 openxml php")
							 ->setCategory("Documento asignación de herramienta");
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D1', 'Herramienta tecnologica')          
			->setCellValue('E1', 'Condición de equipo')
...
while($fila=mysqli_fetch_assoc($rs)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
	            ->setCellValue("A$i", $c)
	            ->setCellValue("B$i", $fila["id_asignacion_herramienta"])
	            ->setCellValue("C$i", $fila["num_documento"])
				->setCellValue("D$i", $fila["descripcion"])	
				->setCellValue("E$i", $fila["condicion_equipo"])
...
$response =  array(
        ...
        'namearchivo'=>'Asignación_herramienta_'.date('dmy')."_".date('Hs')."_".rand(10, 99)
    );
