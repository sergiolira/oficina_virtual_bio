...
<div class="row"> 
    ...
    <div class="col-4 div_cantidad">
        ...
        <div class="input-group mb-2">
            ...
            value="1"/>
            <?php }elseif($obj_detalle_registro_venta->id_tipo_venta=="1" && $_REQUEST["id"]!="0"){?>
            <input type="number" class="form-control valid validNumber"  id="txt_cantidad" name="txt_cantidad" min="1" max='1000' 
    ...
    <div class="col-4">
        ...
        <input type="hidden" name="slt_estado_registro_venta" id="slt_estado_registro_venta" value="<?php echo $fila_p["id_estado_registro_venta"]?>">
        </div>
    </div> 
    <?php }?>
