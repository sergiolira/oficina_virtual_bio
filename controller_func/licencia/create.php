...
?>
  ...
  <div class="row"> 
                   ...
                   <div class="col-4">
                            <label for="txt_lic">Licencia<i class="text-danger" title="Ingrese licencia">*</i></label>
                            <label class="text-danger msj_txt_lic"></label>
                          <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                 <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                              </div>
                              <input type="text" class="form-control valid validText"  id="txt_lic" name="txt_lic" value="<?php echo $obj_lic->licencia; ?>"/>
                          </div>
                   </div>
                   <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <select class="form-control select_t_lic" name="slt_t_lic" id="slt_t_lic" >
                   ...
                   <div class="col-4">
                            <label for="txt_cod">Codigo<i class="text-danger" title="Ingrese un codigo">*</i></label>
                            <label class="text-danger msj_txt_cod"></label>
                          <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                 <span class="input-group-text"><i class="far fa-eye"></i></span>
                              </div>
                              <input type="text" class="form-control valid ValidTextSpecial"  id="txt_cod" name="txt_cod" value="<?php echo $obj_lic->codigo; ?>"/>
                          </div>
                   </div>
                   <div class="col-4">
                            <label for="txt_stock">Stock<i class="text-danger" title="Ingrese el stock">*</i></label>
                            <label class="text-danger msj_txt_stock"></label>
                          <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                 <span class="input-group-text"><i class="far fa-eye"></i></span>
                              </div>
                              <input type="number" class="form-control valid ValidTextSpecial"  id="txt_stock" name="txt_stock" value="<?php echo $obj_lic->stock; ?>"/>
                          </div>
                   </div>
                   <div class="col-4">
