...
$(document).on('click', '#btn_save', function() {
    ...
    var strCampana = document.querySelector('#txt_cat').value;
    ...
    $.ajax({
        ...
        success:function(data){
            if(data.trim()=="true_create"){               
                ...
                $("#modal-form-categoria-preguntas").modal("hide");
                toastr.success("Se agrego una categoria");
                list_categoria_preguntas_frecuente();
