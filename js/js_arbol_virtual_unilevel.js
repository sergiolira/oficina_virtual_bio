...
function editararbolvirtual(){
    ...
    $.get({url:"controller_func/solicitud_arbol_virtual/consultar_edit.php",data: dataString,type: 'POST'}).done(function (response) {
        ...
        OrgChart.slinkTemplates.blue.link = '<path class="path1"  stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#060505" stroke-width="2" fill="none" d="{d}" />';
        ...
        function pdf_redes(nodeId) {
            ...
            chart.exportPDF({
                format:'fit',
                header:'<img  src="imas/logo/logo360x200.png" width="150px" height="100px" />',
