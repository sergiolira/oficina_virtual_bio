          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_z_sup_modal" data-id="0">Nueva Zona de supervisión</button>
                  <button type="button" class="btn btn-success exportar-excel-zona-supervision" title="Exportar Excel" id="exportable">
