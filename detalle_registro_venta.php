  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Detalle Venta</a>
      </li>
          ...
          <div class="col-12">
             ...
             <?php if ($_SESSION['crear']==1) { ?>
               <div class="card-header">
                  <button class="btn btn-info nuevo_detalle_venta_modal" data-id="0">Nuevo Detalle Venta</button>
               ...
               <?php }?>
              <!-- /.card-header -->
              <div class="card-body  table_detalle_venta">
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_marca">Detalle Venta</h4>
...
<!-- js herramienta -->
<script src="js/js_detalle_registro_venta.js"> </script>
<script> 
