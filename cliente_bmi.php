  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Cliente BMI</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Cliente BMI</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cliente BMI</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-info new-modal-cliente-bmi" data-id="0">Nuevo Cliente BMI</button>
                    <button type="buttom" class="btn btn-success exportar-excel-cliente-bmi" id="exportable">Exportar datos <i class="fas fa-file-excel"></i></button>
                </div>
                <div class="card-body table-cliente-bmi">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <div class="modal fade" id="modal-form-cliente-bmi">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Cliente BMI</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_cliente_bmi" id="form_cliente_bmi">
        ...
        <div class="modal fade" id="modal-form-show-cliente-bmi">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form class="form_show_cliente_bmi" id="form_show_cliente_bmi">
...
<!-- js_archivo -->
<script src="js/js_cliente_bmi.js"></script>
<!-- page script -->
<script>
  list_cliente_bmi(); 
</script>
