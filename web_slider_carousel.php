...
<head>
  ...
  <link rel="stylesheet" href="plugins/toastr/toastr.min.css">
  <!-- jquery.maxlength -->
  <link rel="stylesheet" type="text/css" href="plugins/maxlength/jquery.maxlength.css">
    <!--kartik-->
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Carousel dinamico</a></a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Carousel dinamico</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Carousel dinamico</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
          <div class="col-12">
             <div class="card">
              ...
              <?php if ($_SESSION['crear']==1) { ?>               
                  <button class="btn btn-info btn-sm  nuevo_slider_carousel_modal" data-id="0">Nuevo Carousel dinamico</button>
               <?php }?>
                  <button class="btn btn-success btn-sm  activate_banner" data-id="0">Activar carousel dinamico para el index </button>
               </div>
              <!-- /.card-header -->
              <div class="card-body  table_slider_carousel">
          ...
          <div class="col-12">
            ...
            <a  href="">
              <div class="card">
                <img src="archivos/imas_web/ima3.png" class="img-fluid" alt="...">
              </div>
            </a>            
          </div>
    ...
    <div class="modal fade" id="modal-form-slider-carousel">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title title_marca">Carousel dinamico</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  <div class="modal-body">
                    <form id="form_siler_carousel" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="modal-show-slider-carousel">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Carousel dinamico</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_slider_carousel">
...
<!-- js herramienta -->
<script src="js/js_web_slider_carousel.js"> </script>
<script> 
