  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Costo de Envio</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Costo de Envio</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Costo de Envio</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-12">
             ...
             <?php if ($_SESSION['crear']==1) { ?>
               <div class="card-header">
                  <button class="btn btn-info nuevo_costo_envio_modal" data-id="0">Nuevo Costo de Envio</button>
               ...
               <?php }?>
              <!-- /.card-header -->
              <div class="card-body  table_costo_envio">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-costo-envio">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_marca">Costo de Envio</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
              <div class="modal-body">
                <form id="form_costo_envio">
      ...
      <!-- /.modal -->
      <div class="modal fade" id="modal-show-costo-envio">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalle Costo de Envio</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_costo_envio">
...
<!-- js herramienta -->
<script src="js/js_costo_envio.js"> </script>
<script> 
     list_costo_envio();
</script>
