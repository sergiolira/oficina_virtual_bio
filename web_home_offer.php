  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Web home offer</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">web home offer</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Web home offer</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-12">
             ...
             <?php if ($_SESSION['crear']==1) { ?>
               <div class="card-header">
                  <button class="btn btn-info btn-sm  nuevo_web_offer" data-id="0">Nuevo Web home offer</button>
               </div>
               <?php }?>
              <!-- /.card-header -->
              <div class="card-body  table_web_offer">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-web-offer">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_marca">web home offer</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
              <div class="modal-body">
                <form id="form_web_offer" enctype="multipart/form-data">
      ...
      <!-- /.modal -->
      <div class="modal fade" id="modal-show-web-offer">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">web home offer</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_web_offer">
...
<!-- js herramienta -->
<script src="js/js_web_home_offer.js"> </script>
<script> 
     list_Web_home_offer();
</script>
</body>
