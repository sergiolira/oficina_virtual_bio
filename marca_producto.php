  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Marca producto</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Marca producto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Marca producto</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <?php if ($_SESSION['crear']==1 || $_SESSION['idUser']==1) { ?>
                        <button class="btn btn-info new-modal-marca" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo marca</button>
                    <?php }?>
                    </div>
                    <div class="card-body table-marca"> 
        ...
        <!-- INICIA MODAL Marca producto-->
        <div class="modal fade" id="modal-form-marca">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Marca producto</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form_marca" id="form_marca">
        ...
        <!-- FIN MODAL Marca producto -->

        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-marca">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Detalle Marca producto</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div>
...
<!-- js Marca producto -->
<script src="js/js_marca_producto.js"></script>
<script>
  list_marca_producto();
