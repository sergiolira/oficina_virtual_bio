...
<head>
  ...
  <title> Sub categoria producto</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">sub categoria producto</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">sub categoria producto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <?php if ($_SESSION['crear']==1 || $_SESSION['idUser']==1) { ?>
                        <button class="btn btn-info new-modal-sub-categoria" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo</button>
                    <?php }?>
                    </div>
                    <div class="card-body table-sub-categoria"> 
        ...
        <!-- INICIA MODAL sub categoria producto-->
        <div class="modal fade" id="modal-form-sub_categoria">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form_sub_categoria" id="form_sub_categoria" role="form" enctype="multipart/form-data">
        ...
        <!-- FIN MODAL categoria producto -->

        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-subcategoria">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Detalle sub categoria producto</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form id="form_show_sub_categoria">
...
<script src="js/js_sub_categoria_producto.js"></script>
<script>
