  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Categoria producto</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Categoria producto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <?php if ($_SESSION['crear']==1 || $_SESSION['idUser']==1) { ?>
                        <button class="btn btn-info new-modal-categoria" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo categoria</button>
                    <?php }?>
                    </div>
                    <div class="card-body table-categoria"> 
        ...
        <!-- INICIA MODAL categoria producto-->
        <div class="modal fade" id="modal-form-categoria">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form_categoria" id="form_categoria" role="form" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-form-show-categoria">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Detalle categoria producto</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form id="form_show_categoria">
...
<script src="js/js_categoria_producto.js"></script>
<script>
