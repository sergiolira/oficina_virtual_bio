  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Tipo documentos</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tipo documentos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <?php if ($_SESSION['ver']==1) { ?>
                    <button class="btn btn-info new-modal-tipo-documento" data-id="0">Nuevo tipo documento</button>
                  <?php }?>
                </div>
                <div class="card-body table-tipo-documento">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO tipo_documento -->
        <div class="modal fade" id="modal-form-tipo-documento">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form_tipo_documento" id="form_tipo_documento">
        ...
        <!-- FIN MODAL TIPO tipo_documento -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-tipo-documento">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle tipo de Informacion</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_tipo_documento" id="form_show_tipo_documento">
...
<!-- js_tipo_documento -->
<script src="js/js_tipo_documento.js"></script>
<!-- page script -->
<script>
  list_tipo_documento();
