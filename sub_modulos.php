  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">sub modulo</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">sub modulo</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Sub modulos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <?php if ($_SESSION['crear']==1) { ?>
                    <button class="btn btn-info new-modal-sub-modulos" data-id="0">Nuevo sub modulos</button>
                    <button type="button" class="btn btn-success exportar-excel-sub-modulo" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                    <?php }?>
                </div>
                <div class="card-body table-tipo-sub-modulos">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO sub_modulo -->
        <div class="modal fade" id="modal-form-sub-modulos">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">sub modulo</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_sub_modulos" id="form_sub_modulos">
        ...
        <!-- FIN MODAL TIPO sub_modulo -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-sub-modulos">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle sub moduloss</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_sub_modulos" id="form_show_sub_modulos">
...
<!-- js_sub_modulo -->
<script src="js/js_sub_modulo.js"></script>
<!-- page script -->
<script>
  list_sub_modulos();
