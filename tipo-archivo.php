  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Tipo de archivo</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tipo de Archivo</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tipo archivo</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <button class="btn btn-info new-modal-archivo" data-id="0">Nuevo Archivo</button>
                </div>
                <?php }?>
                <div class="card-body table-tipo-Archivo">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO ARCHIVO -->
        <div class="modal fade" id="modal-form-archivo">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form_archivo" id="form_archivo">
        ...
        <!-- FIN MODAL TIPO ARCHIVO -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-archivo">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form class="form_show_archivo" id="form_show_archivo">
...
<!-- js_archivo -->
<script src="js/tipo_archivo.js"></script>
<!-- page script -->
<script>
  list_tipoarchivo();
