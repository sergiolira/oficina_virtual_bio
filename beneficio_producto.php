...
<head>
  ...
  <title>Beneficio producto</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Beneficio producto</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Beneficio producto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Beneficio producto</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-beneficio_producto" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo beneficio producto</button>
                </div>
              <?php }?>
                <div class="card-body table-beneficio_producto">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO beneficio_producto -->
        <div class="modal fade" id="modal-form-beneficio_producto">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Beneficio producto</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_beneficio_producto" id="form_beneficio_producto">
        ...
        <!-- FIN MODAL TIPO beneficio_producto -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-beneficio_producto">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle beneficio producto</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_beneficio_producto" id="form_show_beneficio_producto">
...
<!-- js_beneficio_producto -->
<script src="js/js_beneficio_producto.js"></script>
<!-- page script -->
<script>
