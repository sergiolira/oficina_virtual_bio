  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Medio Pago</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Medio de Pago</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
               <div class="card-header">
                  <button class="btn btn-info nuevo_medio_modal" data-id="0">Nuevo Medio de Pago</button>
               </div>
                  
              <!-- /.card-header -->
              <div class="card-body  table_medio">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-medio">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_medio">Medio de Pago</h4>
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gmedio">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-medio">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles Medio de Pago</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_medio">
...
<!-- js herramienta -->
<script src="js/js_medio_pago.js"> </script>
<script> 
     list_medio_pago();
</script>
