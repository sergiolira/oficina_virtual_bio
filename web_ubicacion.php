...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="modal fade" id="modal_form-web_ubicacion">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Web ubicacion</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form_web_ubicacion" id="form_web_ubicacion" role="form" enctype="multipart/form-data">
...
<script src="js/js_web_ubicacion.js"></script> 
<script>
    list_web_ubicacion();
</script>
</body>
