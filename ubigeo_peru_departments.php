...
<head>
  ...
  <title>ubigeo_peru_departments</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">ubigeo_peru_departments</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ubigeo_peru_departments</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ubigeo_peru_departments</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          <div class="row">
            ...
            <div class="card">
                ...
                <!-- <?php if ($crear==1) { ?>
                    <button class="btn btn-info new-modal-ubigeo-peru-departments" data-id="0">Nuevo Province</button>
                  <?php }?>
                </div> -->
                <div class="card-body table-ubigeo-peru-departments">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL ubigeo_peru_departments -->
        <div class="modal fade" id="modal-form-ubigeo-peru-departments">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">ubigeo_peru_departments</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_ubigeo_peru_departments" id="form_ubigeo_peru_departments">
        ...
        <!-- FIN MODAL ubigeo_peru_departments -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-ubigeo-peru-departments">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle ubigeo_peru_departments</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_ubigeo_peru_departments" id="form_show_ubigeo_peru_departments">
...
<!-- js_ubigeo_peru_departments -->
<script src="js/js_ubigeo_peru_departments.js"></script>
<!-- page script -->
<script>
