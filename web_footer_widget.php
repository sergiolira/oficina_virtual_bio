  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Web footer widget</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Web footer widget</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Web footer widget</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info btn-sm  nuevo_wfw_modal" data-id="0">Nuevo Web footer widget</button>
                  <button type="button" class="btn btn-success btn-sm exportar-excel-web-footer-widget" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                <?php } ?>
               </div>
               
              <!-- /.card-header -->
              <div class="card-body  table_wfw">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-wfw">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_wfw">Web footer widget</h4>
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gwfw">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-wfw">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles Web footer widget</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_wfw">
...
<!-- js herramienta -->
<script src="js/js_web_footer_widget.js"> </script>
<script> 
