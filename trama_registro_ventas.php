  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Trama de ventas</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Trama de ventas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
             <div class="card">
                ...
                <div class="card-header"  align="center">
                    <button class="btn btn-warning btn-sm consult_trama_ventas" data-id="0">Consultar</button>
             ...
             <!-- /.card-header -->
             <div class="card-body tbl_trama_ventas"></div>
          </div>
        </div>
      <!-- /.modal -->
...
<!-- js herramienta -->
<script src="js/js_trama_registro_ventas.js"> </script>
