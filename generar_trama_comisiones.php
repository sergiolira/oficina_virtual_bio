...
<head>
  ...
  <title>Generar trama de comisiones completadas </title>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Registro de ventas completadas</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Registro de ventas completadas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Registro de ventas completadas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
                ...
                <div class="card-header"  align="center">
                    <button class="btn btn-info btn-sm consult_resgistro_ventas_completadas" data-id="0">Consultar</button>
                </div>
                <?php }?>                
             </div>
             <!-- /.card-header -->
        ...
        <div class="tbody_list_trama_temporal">
