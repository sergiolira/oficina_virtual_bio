  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">estado civil</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">estado civil</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
            ...
            <div class="card">
              <?php if ($_SESSION['crear']==1) { ?>
                <div class="card-header">
                    <button class="btn btn-info new-modal-estado-civil" data-id="0">Nuevo estado civil</button>
                </div>
              <?php }?>
                <div class="card-body table-estado-civil">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL TIPO estado-civil -->
        <div class="modal fade" id="modal-form-estado-civil">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form_estado_civil" id="form_estado_civil">
        ...
        <!-- FIN MODAL TIPO estado-civil -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-estado-civil">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form class="form_show_estado_civil" id="form_show_estado_civil">
...
<!-- js_estado_civil -->
<script src="js/js_estado_civil.js"></script>
<!-- page script -->
<script>
  list_estado_civil();
