...
<title>ProLife | Solicitudes de Lideres de Red</title>
<!-- InstanceEndEditable -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header"><!-- InstanceBeginEditable name="region_content_header" -->
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Solicitudes de Lideres de Red</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="oficina">Oficina</a></li>
              <li class="breadcrumb-item active">Solicitudes de Lideres de Red</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- page script -->
<script>
list_solicitudes_arbolvirtual_repre();
</script>
</body>
<!-- InstanceEnd --></html>
<?php } else {
