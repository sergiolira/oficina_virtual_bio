  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Registro de compra</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Registro de compra</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
          ...
          <div class="col-12">
             <div class="card">
               ...
               <?php if ($_SESSION['crear']==1) { ?>
                  <button class="btn btn-info nuevo_r_c_modal" data-id="0">Nuevo registro de compra</button>
                  <button type="button" class="btn btn-success exportar-excel-registro-compra" title="Exportar Excel" id="exportable">
                    Exportar Datos <i class="fas fa-file-excel"></i></button>
                <?php } ?>
               </div>
               
              <!-- /.card-header -->
              <div class="card-body  table_r_c">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-r_c">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_r_c">Registro de compra</h4>
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gr_c">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-r_c">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles registro de compra</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_r_c">
...
<!-- js herramienta -->
<script src="js/js_registro_compra.js"> </script>
<script> 
