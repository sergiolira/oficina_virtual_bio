...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          <div class="col-12">
             <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body  table_web_menu">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-web_menu">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                <form id="form_web_menu">
               
                </form>
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gweb_menu">Guardar</button>
      ...
      <div class="modal fade" id="modal-show-web_menu">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
...
<!-- js herramienta -->
<script src="js/js_web_menu.js"> </script>
<script> 
     list_web_menu();
</script>
