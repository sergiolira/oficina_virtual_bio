...
<head>
  ...
  <title>ubigeo_peru_provinces</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">ubigeo_peru_provinces</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ubigeo_peru_provinces</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ubigeo_peru_provinces</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <!-- <?php if ($crear==1) { ?>
                    <button class="btn btn-info new-modal-ubigeo-peru-provinces" data-id="0">Nuevo Province</button>
                  <?php }?> -->
                </div>
                <div class="card-body table-ubigeo-peru-provinces">
                <!-- /.cargar lista -->
                </div>
                <!-- /.card-body -->
            </div>
        ...
        <!-- INICIA MODAL ubigeo_peru_provinces -->
        <div class="modal fade" id="modal-form-ubigeo-peru-provinces">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">ubigeo_peru_provinces</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_ubigeo_peru_provinces" id="form_ubigeo_peru_provinces">
        ...
        <!-- FIN MODAL ubigeo_peru_provinces -->
        <!-- INICIA MODAL TIPO SHOW -->
        <div class="modal fade" id="modal-form-show-ubigeo-peru-provinces">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">Detalle ubigeo_peru_provinces</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form class="form_show_ubigeo_peru_provinces" id="form_show_ubigeo_peru_provinces">
...
<!-- js_ubigeo_peru_provinces -->
<script src="js/js_ubigeo_peru_provinces.js"></script>
<!-- page script -->
<script>
