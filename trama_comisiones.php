...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <?php if ($_SESSION['crear']==1 || $_SESSION['idUser']==1) { ?>
                        <button class="btn btn-info new_trama_comision" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo registro</button>
                    <?php }?>
                    </div>
                    <div class="card-body table_trama_comisiones"> 
        ...
        <div class="modal fade" id="modal_form-trama">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form_trama_comision" id="form_trama_comision" role="form" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-form-show-trama">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form id="form_show_trama_comisiones">
...
<script src="js/js_trama_comisiones.js"></script> 
<script>
    list_trama_com();
</script>
</body>
