  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Ubicacion Web</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubicacion Web</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ubicacion Web</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <?php if ($_SESSION['crear']==1 || $_SESSION['idUser']==1) { ?>
                        <button class="btn btn-info btn-sm  new_web_mensaje" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo Registro</button>
                    <?php }?>
                    </div>
                    <div class="card-body table_web_mensaje"> 
        ...
        <div class="modal fade" id="modal_form-web_mensaje">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Mensaje Contacto</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form_web_mensaje" id="form_web_mensaje" role="form" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-form-show-web_ubicacion">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
...
<script src="js/js_web_mensaje_contacto.js"></script> 
<script>
    list_web_mensaje();
</script>
</body>
