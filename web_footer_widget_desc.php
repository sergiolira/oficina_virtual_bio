...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-wfwd-inline-block">
        <a href="index3.html" class="nav-link">Web footer widget desc</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-wfwd-6">
            <h1 class="m-0 text-dark">Web footer widget desc</h1>
          </div><!-- /.col -->
          <div class="col-wfwd-6">
            <ol class="breadcrumb float-wfwd-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Web footer widget desc</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
          <div class="col-12">
             <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body  table_wfwd">
                
              </div>
             </div>
          </div>
        </div>
        <div class="modal fade" id="modal-form-wfwd">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title title_wfwd">Web footer widget desc</h4>
              <button type="button" class="close" data-diwfwdiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
               ...
               <div class="modal-footer" style="justify-content: center;">
                  <button type="button" class="btn btn-success" id="btn_gwfwd">Guardar</button>
                  <button type="button" class="btn btn-default" data-diwfwdiss="modal">Cerrar</button>
      ...
      <div class="modal fade" id="modal-show-wfwd">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title ">Detalles Web footer widget desc</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="form_show_wfwd">
...
<footer class="main-footer">
    ...
    All rights reserved.
    <div class="float-right d-none d-wfwd-inline-block">
...
<!-- js herramienta -->
<script src="js/js_web_footer_widget_desc.js"> </script>
<script> 
