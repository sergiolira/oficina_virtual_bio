          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" >
                  <form action="editar_arbol_virtual_dibujar.php" method="POST" id="frmedit_con_arbol_virtual_redibujar">
                    <div class="row">
                      <div class="col-4">
                        ...
                        <input type="hidden" value="<?php echo $_REQUEST["dibujo_red_mlm"];?>" name="dibujo_red_mlm" id="dibujo_red_mlm">                    
